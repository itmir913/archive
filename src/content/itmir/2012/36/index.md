...
`./make.sh menuconfig`진입해서 General setup으로 들어간뒤 Local Version부분에서 엔터 하시고 입력하시면 됩니다
...
`General setup / Kernel log buffer size`가 기본으로 17으로 되어 있습니다
...
`System Type/[ ]Set Min/Max CPU frequencies`를 활성화 하게 되면 아래 나타나게 됩니다
