---
title: "아이폰 아이패드 기타 프로(Guitar Pro) Tab 무료 앱 추천 (안드로이드, PC 포함)"
date: "2020-03-15T01:28:58+09:00"
category: "Application"
tags: []
description: "정말 오랜만에 블로그에 글을 써보네요."
draft: false
original_url: "https://itmir.tistory.com/658"
---
...
‎모든 음악가를 위한 기타프로(Guitar Pro) 앱으로 윈도즈 및 맥용 기타프로(Guitar Pro) 소프트웨어로 작성된 악보와 태블러처를 읽고 들을 수 있습니다. 모바일앱 버전으로 언제 어디서든지 여러분이 좋아하는 곡을 연습하고 공유할 수 있습니다. 아르페지오, 악절, 화음 전개가 머릿속에 떠오르나요? 솔로 트랙 태블러처 메모장을 사용하세요. 만능 악보 리더기 • 지원 포맷 GP3/4/5/6/7 (.gp) 및 PowerTab (.ptb) • 태블러처

apps.apple.com](https://apps.apple.com/kr/app/guitar-pro/id400666114)
...
‎Mulody Guitar is an interactive guitar tablature player which plays synthesized audio and recorded audio synchronously with your tab. In Mulody Guitar, you can add real-person recorded audio INTO your tabs. Other than the synthesized audio automatically g

apps.apple.com](https://apps.apple.com/kr/app/mulody-guitar-tab-player/id1109966537)
...
[Guitar Tab Player - Google Play 앱

Guitar Tab Player는 매우 간단하고 빠른 리더기, 실행기입니다. 타브와 음악 악보를 볼 수있게 해주고 실행을 간단하게 할 수 있습니다. (Guitar Pro 6를 포함한)기타 프로그램을 제공해 줍니다. 그렇기 때문에 원하는 파일을 읽고 실행시킬 수 있습니다! - 제스쳐를 사용하여 페이지를 전환시킬 수 있습니다. - 긴 터치로 추가 메뉴를 이용할 수 있습니다. - 박자 계수기를 클릭하면 박자를 조정할 수 있습니다. ----- 22.09.2016

play.google.com](https://play.google.com/store/apps/details?id=guitartab.player&hl=ko)
...
[[Computer/PC] - 무료 기타프로 프로그램 TuxGuitar](https://itmir.tistory.com/640)

[무료 기타프로 프로그램 TuxGuitar

기타프로 프로그램을 구입하기에는 너무 비싸서 다른 프로그램은 없을까 찾아보니, 오픈소스 프로젝트로 gp5 파일을 열 수 있는 프로그램을 찾았습니다. 프로그램의 이름은 TuxGuitar입니다. https://sourceforge..

itmir.tistory.com](https://itmir.tistory.com/640)
...
‎TEFview for iOS is an app that allows you to view, print and play tablatures created in TablEdit Tablature Editor on your iPad, iPhone or iPod touch. TEFview allows you as well to view and listen to ASCII tabs, ABC tunes, MIDI, PowerTab, GuitarPro and mus

apps.apple.com](https://apps.apple.com/kr/app/tefview/id492060413)
