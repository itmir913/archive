...
중국의 su_ky님께서 기반을 만드셨으며, 좀더 다듬어서 만들어 졌습니다
...
3. 기기명을 입력받은다음 엔터를 누르면 압축푼 폴더의 sky_update폴더안에 '기기명' 폴더가 생깁니다
...
4 sky_update안에 생긴 기기명 폴더안에 BINX를 넣어주세요 이름은 상관 없습니다
...
위 사진처럼 log Dll 초기화 실패 오류가 나타날경우 압축파일안에 들어있는 Del_ActiveX.cmd를 실행해 주세요
