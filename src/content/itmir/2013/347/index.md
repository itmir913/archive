...
seekbar.setOnSeekBarChangeListener(new SeekBar\_Listener());

위처럼 class를 새로 만들어서 리스너를 만들수 있습니다

class SeekBar\_Listener implements OnSeekBarChangeListener {
...
Settings.System.putInt(getContentResolver(), "screen\_brightness", 0~255);
...
if(Settings.System.getInt(getContentResolver(), Settings.System.SCREEN\_BRIGHTNESS\_MODE) != 1)

    Settings.System.putInt(getContentResolver(), Settings.System.SCREEN\_BRIGHTNESS\_MODE, 1);
