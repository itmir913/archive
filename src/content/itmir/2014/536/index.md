...
[[Development/App] - FadingActionBar를 사용해 보자 - Play Store UI](/archive/itmir/2014/526)
...
위 Holo_Light가 아니더라도 TranslucentDecor가 있는것을 선택하시면 됩니다

xml에서는 @android:style/Theme.Holo.Light.NoActionBar.TranslucentDecor

java에서는 setTheme(android.R.style.Theme_Holo_Light_NoActionBar_TranslucentDecor)
