...
다운로드](./file/SampleActivity.apk)

[SampleFingerScan 주석.zip

다운로드](./file/SampleFingerScan 주석.zip)

[PantechFingerSDK-master.zip

다운로드](./file/PantechFingerSDK-master.zip)
...
[VEGA 지문인식 SDK 설치 가이드.pdf

다운로드](./file/VEGA 지문인식 SDK 설치 가이드.pdf)
