...
[SampleActivity.apk](./file/SampleActivity.apk)

[SampleFingerScan 주석.zip](./file/SampleFingerScan 주석.zip)

[PantechFingerSDK-master.zip](./file/PantechFingerSDK-master.zip)
...
[VEGA 지문인식 SDK 설치 가이드.pdf](./file/VEGA 지문인식 SDK 설치 가이드.pdf)
