...
[[Android Build] - 1) 안드로이드를 빌드하기 전에 빌드 환경을 구축하자](/archive/itmir/2013/220)

권장글

[[Android Build] - 2) CyanogenMod 소스를 받고 빌드해 보자](/archive/itmir/2013/221)

[[Ubuntu] - Ubuntu의 저장소를 daum.net으로 바꿔보자 (apt-get 속도향상)](/archive/itmir/2013/265)
