...
export const timeline: TimelineEntry[] = [
  ...
  },
  {
    ...
    description: 'Stepped back from Android ecosystems to study C, data structures, and algorithms from scratch.',
  ...
  },
  {
    ...
    description: 'Expanded from app development into Linux, networking, virtualization, and home server administration.',
  ...
  },
  {
    ...
    description: 'Rebuilt a school app with Material Design and shipped it to real users.',
